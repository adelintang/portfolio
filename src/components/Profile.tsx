export default function Profile() {
  return (
    <section className="dark:bg-dark">
      <div
        className="py-10 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center lg:flex-row gap-2">
        <div>
          ...
          <p className="dark:text-white">Fullstack Javascript | Informatics Engineering Student College</p>
        </div>
