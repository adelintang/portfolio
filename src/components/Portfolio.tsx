...
const Nestjs = <SiNestjs className="text-2xl text-[#E0234E] cursor-pointer" />;
const MongoDB = (
  <SiMongodb className="text-2xl text-[#4DB33D] cursor-pointer" />
);
const MySQL = <SiMysql className="text-3xl text-[#00758F] cursor-pointer" />;
const Typescript = (
...
const portfolios: Portfolio[] = [
  ...
  {
    picture: "/img/financial-tracker.PNG",
    alt: "financial-tracker-api",
    urlApp: "https://financial-tracker-api.vercel.app/docs",
    name: "Financial Tracker API",
    description: "Rest API Financial Tracker, Financial Tracker",
    repository: "https://github.com/adelintang/financial-tracker",
    techs: [
      { icon: Typescript, tooltipTilte: "Typescript" },
      { icon: NodeJS, tooltipTilte: "NodeJS" },
      { icon: Nestjs, tooltipTilte: "Nestjs" },
      { icon: Prisma, tooltipTilte: "Prisma" },
      { icon: MySQL, tooltipTilte: "MySQL" },
    ],
    category: "Back-End",
  },
];
      ...
      <div className="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto">
        ...
        <div className="mt-4 grid gap-6 grid-cols-1 md:grid-cols-2">
          {portfolios.map((portfolio, index) => (
            <div
              className="bg-white dark:bg-[#14213D] shadow-md rounded-md"
              key={index}
            >
              <img
              ...
              <div className="p-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline text-[#2F74C8]"
                >
                  Repository
                </a>
